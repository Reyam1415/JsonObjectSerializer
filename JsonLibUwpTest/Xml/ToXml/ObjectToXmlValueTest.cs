...
{
    [TestClass]
    public class ObjectToXmlValueUwpTest
    {
        ...
        public void TestDictionary_WithExoticKeyAndIntValue()
        {
            ...
            Assert.AreEqual(XmlValueType.String, result1.Values["Key"].ValueType);
            Assert.AreEqual("Key", result1.Values["Key"].NodeName);
            Assert.AreEqual("JsonLibTest.MyItem, JsonLibUwpTest, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ((XmlString)result1.Values["Key"]).Value);
            ...
            Assert.AreEqual(XmlValueType.String, result2.Values["Key"].ValueType);
            Assert.AreEqual("Key", result2.Values["Key"].NodeName);
            Assert.AreEqual("JsonLibTest.MyItem2, JsonLibUwpTest, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ((XmlString)result2.Values["Key"]).Value);
