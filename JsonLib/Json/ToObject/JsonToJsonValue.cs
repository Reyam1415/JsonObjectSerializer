...
namespace JsonLib.Json
{
    ...
    public class JsonToJsonValue : IJsonToJsonValue
    {
        ...
        public IJsonValue ToJsonValue(char[] jsonChars, ref int index)
        {
            var token = this.LookAheadNextToken(jsonChars, index);
            switch (token)
            {
                case JsonToken.String:
                    return new JsonString(this.ParseString(jsonChars, ref index));
                case JsonToken.Number:
                    return new JsonNumber(this.ParseNumber(jsonChars, ref index));
        ...
        public JsonObject ToJsonObject(char[] jsonChars, ref int index)
        {
        ...
        public JsonArray ToJsonArray(char[] jsonChars, ref int index)
        {
        ...
        public IJsonValue ToJsonValue(string json)
        {
